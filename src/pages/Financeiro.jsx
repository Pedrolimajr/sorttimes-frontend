...
export default function Financeiro() {
  ...
  const [tipoFiltro, setTipoFiltro] = useState('nome'); // 'nome', 'Adimplente', 'Inadimplente'
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-3 sm:mb-4">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <div className="relative flex-1 sm:flex-none">
            {/* Campo de seleção para filtrar por nome ou status */}
            <select
              value={filtroStatus}
                ...
                {jogadores
                  .filter(jogador => {
                    if (filtroStatus === 'todos') {
                      return jogador.nome.toLowerCase().includes(filtroNome.toLowerCase());
                    }
                    return jogador.statusFinanceiro === filtroStatus;
                  })
                  .map((jogador) => (
