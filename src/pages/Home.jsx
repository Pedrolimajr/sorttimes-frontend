...
export default function PaginaInicial() {
  return (
    <div className="min-h-screen bg-[#020617] text-slate-100 flex flex-col items-center px-4 sm:px-8 py-12 sm:py-20 relative">
      ...
      <div className="max-w-2xl mx-auto flex flex-col items-center text-center relative z-10 my-auto w-full">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, ease: "easeOut" }}
          className="space-y-8 sm:space-y-12 lg:space-y-12 flex flex-col items-center w-full"
        >
          {/* Cabeçalho com logo */}
          ...
          <Link to="/login" className="block w-fit">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 text-white font-black py-4 lg:py-5 px-10 lg:px-14 rounded-[2rem] shadow-xl hover:shadow-blue-500/25 transition-all flex items-center gap-4 text-xs lg:text-sm uppercase tracking-[0.2em]"
            >
