...
import { FaTrophy, FaUserTimes, FaAward, FaFutbol, FaCheckCircle, FaLock, FaUser, FaChartBar, FaShareAlt, FaEye, FaEyeSlash, FaClock } from 'react-icons/fa';
      ...
      <div className="max-w-md mx-auto space-y-8">
        ...
        <AnimatePresence mode="wait">
          ...
          {etapa === 'admin' && (
            ...
            >
              <h2 className="text-xl font-black text-center bg-gradient-to-r from-yellow-400 to-amber-600 bg-clip-text text-transparent flex items-center justify-center gap-2 uppercase tracking-tighter">
